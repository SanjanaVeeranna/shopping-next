          ...
          <div>
            <div className="mt-10">
              ...
              <div className="ml-16 mt-4 font-bold">
                Exclusive Offers Available, Order soon and get Unbeateble
                Products in cheaper Prize
              </div>
          ...
          <div className="ml-16 mt-36 w-full max-w-2xl">
            <div className="mt-10 text-white">
              ...
              <div className="ml-4 mt-4 font-bold">
                Pro-Fashion has absolutely everything you will ever need to
                create a beutiful and attention grabbing outfits and show case
                all your products in a simple awe-inspiring manner with ease.
              </div>
